...
static int mtk_eth_debugfs_c22_phyregs_show(struct seq_file *m, void *private)
{
	...
	for (i = 0 ; i < MTK_MAX_DEVS ; i++) {
		...
		if (!mac ||
		    ...
		    phylink_autoneg_inband(mac->mode))
			continue;
...
static int mtk_eth_debugfs_tx_full_cnt_show(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
	int cnt;
...
DEFINE_SHOW_ATTRIBUTE(mtk_eth_debugfs_tx_full_cnt);
...
void mt7530_dump_each_port(struct seq_file *m, struct mtk_eth *eth, u32 base)
{
	u32 pkt_cnt = 0;
	int i = 0;
...
int mtk_esw_cnt_read(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
...
void mtk_mac_mib_dump(struct seq_file *m, u32 gdm_id)
{
	struct mtk_eth *eth = m->private;
...
int mtk_eth_debugfs_mac_cnt_show(struct seq_file *m, void *v)
{
	int i;
...
void mtk_xfi_mib_dump(struct seq_file *m, u32 gdm_id)
{
	struct mtk_eth *eth = m->private;
...
int mtk_eth_debugfs_xfi_cnt_show(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
	int i;
...
int mtk_tx_ring_read(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
...
int mtk_hwtx_ring_show(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
...
int mtk_rx_ring_show(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
...
int mtk_dbg_regs_show(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
	u32 i;
...
int mtk_hwlro_stats_show_v1(struct seq_file *m, struct mtk_eth *eth, void *v)
{
	int i;
...
int mtk_hwlro_stats_show_v2(struct seq_file *m, struct mtk_eth *eth, void *v)
{
	int i;
...
int mtk_hwlro_stats_show(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
...
ssize_t mtk_hwlro_stats_write(struct file *file, const char __user *buffer,
			   size_t count, loff_t *data)
{
	struct seq_file *m = (struct seq_file *)file->private_data;
	struct mtk_eth *eth = m->private;
...
int mtk_hwlro_agg_cnt_ctrl(struct mtk_eth *eth, int cnt)
{
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
	int i;
...
int mtk_hwlro_agg_time_ctrl(struct mtk_eth *eth, int time)
{
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
	int i;
...
int mtk_hwlro_age_time_ctrl(struct mtk_eth *eth, int time)
{
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
	int i;
...
int mtk_hwlro_threshold_ctrl(struct mtk_eth *eth, int bandwidth)
{
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
...
int mtk_hwlro_ring_enable_ctrl(struct mtk_eth *eth, int enable)
{
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
	int i;
...
int mtk_hwlro_stats_enable_ctrl(struct mtk_eth *eth, int enable)
{
...
ssize_t mtk_hwlro_auto_tlb_write(struct file *file, const char __user *buffer,
			      size_t count, loff_t *data)
{
	struct seq_file *m = (struct seq_file *)file->private_data;
	struct mtk_eth *eth = m->private;
...
void mtk_hwlro_auto_tlb_dump_v1(struct seq_file *m, u32 index)
{
	struct mtk_eth *eth = m->private;
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
...
void mtk_hwlro_auto_tlb_dump_v2(struct seq_file *m, u32 index)
{
	struct mtk_eth *eth = m->private;
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
...
void mtk_hwlro_auto_tlb_dump_v3(struct seq_file *m, u32 index)
{
	struct mtk_eth *eth = m->private;
...
int mtk_hwlro_auto_tlb_show(struct seq_file *m, void *v)
{
	struct mtk_eth *eth = m->private;
	const struct mtk_reg_map *reg_map = eth->soc->reg_map;
	int i;
...
int mtk_eth_debugfs_init(struct mtk_eth *eth)
{
	...
	debugfs_create_file("tx_full_cnt", 0444, eth->debugfs->root,
